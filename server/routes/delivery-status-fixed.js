...
// @route   GET /api/delivery-status/test
// @desc    Test route to verify this file is loaded
// @access  Public
router.get('/test', (req, res) => {
  res.json({
    success: true,
    message: 'delivery-status-fixed.js route is loaded!',
...
router.put('/orders/:orderId/status', async (req, res) => {
  ...
  try {
    ...
    // Use the exact order_type to avoid conflicts between regular and custom orders with same ID
